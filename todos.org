...
* High priority
** Set up automatic CI
** DONE Get Astro example going
*** DONE specify language via astro:i18n
*** DONE static mode: i18n pages
*** DONE server mode: auto redirect i18n
*** DONE how should components get the context?
