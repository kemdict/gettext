...
import { getLanguageCode } from "./private.js";

/**
 * @typedef {import("gettext-parser").GetTextTranslations} GetTextTranslations
 * @typedef {import("gettext-parser").GetTextTranslation} GetTextTranslation
 * @typedef {import("gettext-parser").GetTextComment} GetTextComment
...
export default class Gettext {
    /** @type Record<Locale, Record<Domain, GetTextTranslations>> */
    catalogs = {};
    /** @type Array<Listener> */
    listeners = [];
    /**
     ...
     * @param {GetTextTranslations} translations  An object of gettext-parser JSON shape
     */
    ...
    dnpgettext(domain, msgctxt, msgid, msgidPlural, count) {
        ...
        if (translation) {
            if (typeof count === "number") {
                var pluralsFunc =
                    plurals[getLanguageCode(this.locale)].pluralsFunc;
     ...
     * @param  {string} msgctxt  Translation context
     * @param  {string} msgid    String to be translated
     * @return {GetTextTranslation} Translation object or false if not found
     */
    _getTranslation(domain, msgctxt, msgid) {
        msgctxt = msgctxt || "";

        return this.catalogs?.[this.locale]?.[domain]?.translations?.[
            msgctxt
        ]?.[msgid];
    }
    /* C-style aliases */
